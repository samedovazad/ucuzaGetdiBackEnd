    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><a href="{{ route('admin.home') }}" class="navbar-brand nav-link"><img alt="admin logo"
                                                                                             src="{{ asset('assets/admin/images/logo/robust-logo-light.png') }}"
                                                                                             data-expand="{{ asset('assets/admin/images/logo/robust-logo-light.png') }}"
                                                                                             data-collapse="{{ asset('assets/admin/images/logo/robust-logo-small.png') }}"
                                                                                             class="brand-logo"></a>
                </li>
            ...
            <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                ...
                <ul class="nav navbar-nav float-xs-right">
                    <li class="dropdown dropdown-language nav-item"><a id="dropdown-flag" href="#"
                            ...
                            <span class="selected-language">Azərbaycan</span></a>
                        <div aria-labelledby="dropdown-flag" class="dropdown-menu">
                            <a href="{{ route('change_lang',['locale'=> 'az']) }}" class="dropdown-item">Azərbaycan</a>
                            <a href="{{ route('change_lang',['locale'=> 'ru']) }}" class="dropdown-item">Русский</a>
                            <a href="{{ route('change_lang',['locale'=> 'en']) }}" class="dropdown-item">English</a>
                        </div>
                    </li>
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown"
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="list-group scrollable-container"><a href="javascript:void(0)"
                                    ...
                                    <div class="media">
                                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img
                                                        src="{{ asset('assets/admin/images/portrait/small/avatar-s-1.png') }}"
                                                        alt="avatar"><i></i></span></div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left"><span
                                                    class="avatar avatar-sm avatar-away rounded-circle"><img
                                                        src="{{ asset('assets/admin/images/portrait/small/avatar-s-2.png') }}"
                                                        alt="avatar"><i></i></span></div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown"
                                    ...
                                    class="avatar avatar-online"><img
                                        src="{{ asset('assets/admin/images/portrait/small/avatar-s-3.png') }}" alt="avatar"><i></i></span><span
